...
place_label_on_courier(courier_path, label_img, position=(150, 170), size=(185, 270), rotate_angle=270)


# # Add a border to the extracted label
# label_img_with_border = add_border_to_label(label_img, border_width=1, border_color=(0, 0, 0))  # Add a black border of width 15

# # Place the label on the courier image at a fixed position, resize it, and rotate it if needed
# #position =(150, 170) what is 150 and 170?  150 is the x-coordinate and 170 is the y-coordinate of the top-left corner of the label
# place_label_on_courier(courier_path, label_img_with_border, position=(150, 170), size=(185, 270), rotate_angle=270)  # Rotate by 270 degrees
